            ...
            <section className="news">
                ...
                <div className="news-content">
                    <article className="news-item">
                        <img src="../../public/news-img-1.png" alt="" className="news-item-img" />
