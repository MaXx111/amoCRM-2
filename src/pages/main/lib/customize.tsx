                ...
                <div className="customize-content">
                    ...
                    <div className="customize-imgs">
                        <a href="!#" className="customize-img-link">
                            <img src="../../public/customize-img-1.png" alt="customize-img-1" className="customize-img"/>
                        </a>
                        <a href="!#" className="customize-img-link">
                            <img src="../../public/customize-img-2.png" alt="customize-img-2" className="customize-img"/>
                        </a>
                        <a href="!#" className="customize-img-link">
                            <img src="../../public/customize-img-3.png" alt="customize-img-3" className="customize-img"/>
                        </a>
                    </div>
                </div>
            </section>
